...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', paddingHorizontal: Spacing.base, gap: Spacing.sm, paddingBottom: Spacing.base, paddingRight: Spacing.xl },
  tab: { paddingHorizontal: Spacing.base, paddingVertical: Spacing.sm, borderRadius: BorderRadius.full, borderWidth: 1, borderColor: Colors.graphiteBorder, flexShrink: 0 },
  ...
  scenarioGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, paddingHorizontal: 0 },
  scenarioCard: { minWidth: 140, width: 160, backgroundColor: Colors.cardSurfaceNavy, borderRadius: BorderRadius.md, borderWidth: 1, borderColor: Colors.graphiteBorder, padding: 12, alignItems: 'center', gap: 4 },
  scenarioIcon: { fontSize: 28 },
  scenarioTitle: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: Colors.frostWhite, textAlign: 'center' },
  scenarioDesc: { fontFamily: 'Inter_400Regular', fontSize: 11, color: Colors.slateGray, textAlign: 'center' },
