...
const styles = StyleSheet.create({
  ...
  notesInput: { backgroundColor: Colors.cardSurfaceNavy, borderRadius: 10, borderWidth: 1, borderColor: Colors.graphiteBorder, padding: Spacing.base, fontFamily: 'Inter_400Regular', fontSize: Typography.bodyMedium, color: Colors.frostWhite, minHeight: 100, textAlignVertical: 'top', marginBottom: Spacing.md },
